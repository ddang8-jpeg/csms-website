...
const Content: React.FC = () => {
  const data = useStaticQuery(graphql`
    query {
      file(relativePath: { eq: "blog/MN_circuit.jpg" }) {
        childImageSharp {
  ...
  return (
    <div className="justify-center text-justify font-light ">
      ...
      <p className="mb-2 p-2 mx-4">
        ...
        to include brain-machine interfaces and neural prosthesis devices. Specifically, he started looking at spinal
        and cortical prosthesis devices and robotic systems to restore function after injury and for human augmentation.
        This area has required close collaboration with neuroscientists to gain access to animal models (i.e. lamprey,
        cat, ferret and monkey preparations).
      </p>

      <div className="image-block">
        {image && <GatsbyImage image={image} alt="CMOS Mihalas-Niebur Model using switch capacitors" />}
      ...
      <p className="mb-2 bg-white p-2 rounded-md">
        ...
        interface with the human body to restore functionality after injury or to overcome disease. Lastly, we have also
        been working on developing miniaturized ultrasound phased arrays, developing interstitial high intensity
